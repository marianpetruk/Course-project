...
def create_indicators():
    """
    Creates instances of Indicator ADT clss for all eleven aindicators.
...
def data_by_year():
    """
    Program's function for showing data for the particular year.
    """
...
def plot_graph():
    """
    Program's function for making graph for the indicator.
    """
